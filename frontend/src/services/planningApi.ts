...
export type Budget = { id:string; financialYearId:string; department:string; totalAmount:number; committedAmount:number; availableAmount:number; lines:{id:string;allocatedAmount:number;committedAmount:number;availableAmount:number}[] };
