...
[ApiController]
[Route("api/bids")]
public sealed class BidSubmissionsController(IBidSubmissionApplicationService bids) : ControllerBase
{
    ...
    [HttpGet("{id:guid}/documents")] public Task<List<Lca.EProcurement.Domain.BidSubmissionDocument>> Documents(Guid id, CancellationToken ct) => bids.GetDocumentsAsync(id, ct);
