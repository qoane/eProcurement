...
public sealed class InvoiceMatchingController(IInvoiceMatchingApplicationService matching) : ControllerBase
{
    ...
    [HttpPost("{invoiceId:guid}/run")] public Task<Lca.EProcurement.Domain.ThreeWayMatch> Run(Guid invoiceId,ActorDto dto,CancellationToken ct)=>matching.RunAsync(invoiceId,dto,ct);
