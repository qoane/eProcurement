...
public sealed class EProcurementDbContext(DbContextOptions<EProcurementDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<PageDefinition>(b => { ConfigureMetadata(b); b.Property(x => x.PageType).HasConversion<string>().HasMaxLength(64); });
