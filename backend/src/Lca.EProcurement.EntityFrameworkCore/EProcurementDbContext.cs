...
public sealed class EProcurementDbContext(DbContextOptions<EProcurementDbContext> options) : DbContext(options)
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<EntityDefinition>(b => { ConfigureMetadata(b); b.Property(x => x.DisplayName).HasMaxLength(256); b.Property(x => x.PluralName).HasMaxLength(256); b.Property(x => x.DefaultSearchField).HasMaxLength(128); });
